...
pub struct Options {
    ...
    pub evolution: crate::evolution::Config,
}
#[derive(JsonSchema, Clone, Debug, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
...
impl Default for Options {
    fn default() -> Self {
        Self {
            ...
            plus: PlusConfig::default(),
            improve: ImproveConfig::default(),
            evolution: crate::evolution::Config::default(),
        }
    }
}
...
pub struct ImproveConfig {
    /// Fraction of the shared evaluation/time allowance assigned to training.
    pub trainer_share: f64,
    /// Reserve part of the same total budget for direct schedule evolution.
    pub evolution_share: f64,
    /// Maximum number of distinct validated strategies handed to Plus.
    pub policies: usize,
}
impl Default for ImproveConfig {
    fn default() -> Self {
        Self {
            trainer_share: 0.4,
            // Equal-budget ablations did not justify diverting Plus budget by default.
            evolution_share: 0.0,
            policies: 3,
        }
    }
...
pub struct SearchReport {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub operators: Vec<crate::evolution::OperatorReport>,
}
#[derive(JsonSchema, Clone, Debug, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
