...
const searches=[];
for(const method of ['schedule.create','schedule.treesearch','schedule.hypersearch']){
  const plan=await tool(method,{scenario_id:prepared.scenario_id,options:{iterations:16,budget_ms:0,xh:{population_size:8,workers:2},xt:{workers:2,depth:3}}});
