...
try{
 ...
 await page.screenshot({path:path.join(root,'docs/reports/dispatch-viewer.png'),fullPage:true});
 ...
 await page.screenshot({path:path.join(root,'docs/reports/dispatch-rules.png'),fullPage:true});
